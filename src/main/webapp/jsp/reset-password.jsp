    ...
    <div class="nl-split-left">
        ...
        <div class="nl-hero-body">
            <div class="nl-hero-badge">
                <i class="ti ti-shield-check"></i> Zero-Trust Access Control &bull; Credential Update
            </div>
            <h1 class="nl-hero-heading">
                Configure Your New <span>Secure Password.</span>
            </h1>
            <p class="nl-hero-description">
                Create a strong password to safeguard your staff workstation and enterprise operations. Once updated, your credentials are ready for immediate authentication.
            </p>
            ...
            <div class="nl-features-stack">
                <div class="nl-feature-item">
                    ...
                    <div>
                        <div class="nl-feature-title">End-to-End Cryptographic Hashing</div>
                        <div class="nl-feature-text">Your password is encrypted using salted SHA-256 before storage in the secure MySQL repository.</div>
                    </div>
                </div>
                ...
                <div class="nl-feature-item">
                    ...
                    <div>
                        <div class="nl-feature-title">Automatic Session Invalidation</div>
                        <div class="nl-feature-text">Any obsolete login sessions are immediately cleared to prevent unauthorized account access.</div>
                    </div>
                </div>
                ...
                <div class="nl-feature-item">
                    ...
                    <div>
                        <div class="nl-feature-title">Immediate Portal Access</div>
                        <div class="nl-feature-text">Sign in seamlessly with your new credentials without requiring administrative intervention.</div>
                    </div>
                </div>
            </div>
            ...
            <div class="nl-telemetry-panel">
                <div class="nl-tele-col">
                    <div class="nl-tele-number">SHA-256</div>
                    <div class="nl-tele-label">Password Hashing</div>
                </div>
                <div class="nl-tele-col">
                    <div class="nl-tele-number">1-Click</div>
                    <div class="nl-tele-label">Session Sync</div>
                </div>
                <div class="nl-tele-col">
                    <div class="nl-tele-number">100%</div>
                    <div class="nl-tele-label">Verified Handshake</div>
                </div>
            </div>
        </div>
        ...
        <div class="nl-hero-bottom">
            <span>&copy; 2026 N Logistic Global Systems Inc.</span>
            <span>Identity Governance &bull; Enterprise RBAC</span>
        </div>
    </div>

    <!-- RIGHT FORM SPLIT (45% Width) -->
    <div class="nl-split-right">
        <div class="nl-form-container">
            ...
            <div class="nl-form-header">
                ...
                <h2 class="nl-form-title">Set New Password</h2>
                <p class="nl-form-subtitle">Choose a secure password with at least 6 characters to protect your account.</p>
            </div>

            <!-- Alerts -->
            <c:if test="${not empty errorMessage}">
                <div class="nl-alert-banner danger" style="border-radius: 12px; margin-bottom: 20px;">
                    <i class="ti ti-alert-circle fs-5" style="color: #DC2626; flex-shrink: 0; margin-top: 1px;"></i>
                    <div style="font-size: 13.5px; font-weight: 500;">${errorMessage}</div>
                </div>
            </c:if>

            <!-- Reset Password Form -->
            <form action="<c:url value='/reset-password'/>" method="POST" id="resetPasswordForm">
                ...
                <div class="nl-input-group">
                    ...
                    <div class="nl-input-box">
                        ...
                        <input type="password" id="inputNewPassword" name="password" class="nl-text-input" required placeholder="Enter new password" autocomplete="new-password" autofocus>
                        <button type="button" class="nl-password-toggle-btn" onclick="togglePass('inputNewPassword', 'eyeIcon1')" title="Toggle password visibility">
                ...
                <div class="nl-input-group">
                    ...
                    <div class="nl-input-box">
                        <i class="ti ti-shield-check nl-input-lead-icon"></i>
                        <input type="password" id="inputConfirmPassword" name="confirmPassword" class="nl-text-input" required placeholder="Re-enter new password" autocomplete="new-password">
                        <button type="button" class="nl-password-toggle-btn" onclick="togglePass('inputConfirmPassword', 'eyeIcon2')" title="Toggle password visibility">
            ...
            <div class="nl-footer-links" style="margin-top: 28px; text-align: center;">
                <p style="font-size: 13.5px; color: #64748B;">
                    Cancel recovery?
                    <a href="<c:url value='/login'/>" class="nl-link-orange" style="font-weight: 700; margin-left: 4px;">
