...
<div class="container-fluid py-4">
    <div class="d-flex justify-content-between align-items-center mb-4">
        ...
        <!-- Filter Form -->
        <form action="<c:url value='/predictive-graph'/>" method="GET" class="d-flex">
            <select name="type" class="form-select me-2" onchange="this.form.submit()" style="width: 200px; border-radius: 8px;">
            ...
            <div class="card shadow-sm border-0 h-100" style="border-radius: 12px;">
                <div class="card-body p-4">
                    ...
                    <form action="<c:url value='/predictive-graph'/>" method="POST">
                        ...
                        <div class="mb-3">
                            <label class="form-label text-muted fw-bold small">Current Base Price ($)</label>
                            <input type="text" class="form-control bg-light" value="${currentBasePrice}" readonly style="padding: 12px; border-radius: 8px;">
                        </div>
                        
                        <div class="mb-3">
                            <label class="form-label text-muted fw-bold small">New Base Price ($)</label>
                            <input type="number" step="0.01" name="newPrice" class="form-control" required placeholder="Enter new price" style="padding: 12px; border-radius: 8px;">
                        </div>
                        
                        <div class="mb-4">
                            <label class="form-label text-muted fw-bold small">Reason for Change</label>
                            <textarea name="reason" class="form-control" required rows="3" placeholder="e.g. Due to upcoming peak season" style="padding: 12px; border-radius: 8px;"></textarea>
                        </div>
                        
                        <button type="submit" class="btn btn-dark w-100 py-3" style="border-radius: 8px; font-weight: 600;">
                            Update Price & Log Audit
                        </button>
                    </form>
                </div>
            </div>
