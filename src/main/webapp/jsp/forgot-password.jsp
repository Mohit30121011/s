    ...
    <div class="nl-split-left">
        ...
        <div class="nl-hero-body">
            <div class="nl-hero-badge">
                <i class="ti ti-shield-lock"></i> Zero-Trust Access Control &bull; Identity Recovery
            </div>
            <h1 class="nl-hero-heading">
                Enterprise Account &amp; <span>Credential Recovery.</span>
            </h1>
            <p class="nl-hero-description">
                Safely reset your enterprise access credentials. A cryptographically signed, single-use token will be dispatched directly to your verified corporate email address.
            </p>
            ...
            <div class="nl-features-stack">
                <div class="nl-feature-item">
                    ...
                    <div>
                        <div class="nl-feature-title">Cryptographic One-Time Tokens</div>
                        <div class="nl-feature-text">Time-limited UUID tokens expire in 15 minutes to guarantee uncompromising portal defense.</div>
                    </div>
                </div>
                ...
                <div class="nl-feature-item">
                    ...
                    <div>
                        <div class="nl-feature-title">SHA-256 Encrypted Sync</div>
                        <div class="nl-feature-text">Updated credentials are immediately hashed and synchronized across all multi-tenant databases.</div>
                    </div>
                </div>
                ...
                <div class="nl-feature-item">
                    ...
                    <div>
                        <div class="nl-feature-title">Audited Security Ledger</div>
                        <div class="nl-feature-text">Every recovery dispatch and credential update is immutably recorded in the central compliance audit log.</div>
                    </div>
                </div>
            </div>
            ...
            <div class="nl-telemetry-panel">
                <div class="nl-tele-col">
                    <div class="nl-tele-number">15 min</div>
                    <div class="nl-tele-label">Token Expiry</div>
                </div>
                <div class="nl-tele-col">
                    <div class="nl-tele-number">SHA-256</div>
                    <div class="nl-tele-label">Encryption Standard</div>
                </div>
                <div class="nl-tele-col">
                    <div class="nl-tele-number">24/7</div>
                    <div class="nl-tele-label">Audit Monitoring</div>
                </div>
            </div>
        </div>
    ...
    <div class="nl-split-right">
        <div class="nl-form-container">
            ...
            <div class="nl-form-header">
                ...
                <h2 class="nl-form-title">Forgot Password?</h2>
                <p class="nl-form-subtitle">Enter your registered corporate email address to receive a secure password reset link.</p>
            </div>
            ...
            <c:if test="${not empty successMessage}">
                <div class="nl-alert-banner success" style="border-radius: 12px; margin-bottom: 20px;">
                    <i class="ti ti-circle-check fs-5" style="color: #059669; flex-shrink: 0; margin-top: 1px;"></i>
                    <div style="font-size: 13.5px; font-weight: 500;">${successMessage}</div>
                </div>
            </c:if>
            ...
            <form action="<c:url value='/forgot-password'/>" method="POST">
                <div class="nl-input-group">
                    <div class="nl-label-row">
                        <label for="inputEmail">Corporate Email Address</label>
                    </div>
                    <div class="nl-input-box">
                        <i class="ti ti-mail nl-input-lead-icon"></i>
                        <input type="email" id="inputEmail" name="email" class="nl-text-input" required placeholder="e.g. arjun@nlogistic.com" autocomplete="email" autofocus>
                    </div>
                </div>
